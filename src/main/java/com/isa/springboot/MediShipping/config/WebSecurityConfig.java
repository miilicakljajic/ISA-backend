package com.isa.springboot.MediShipping.config;
...
import com.isa.springboot.MediShipping.security.RestAuthenticationEntryPoint;
import com.isa.springboot.MediShipping.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/auth/**").permitAll()		// /auth/**
                ...
                .antMatchers("/api/users/byid/**").permitAll()
                .antMatchers("/api/consumer/*").permitAll()
                .antMatchers("/api/consumer/location/*").permitAll()
                .antMatchers("/api/consumer/get/*").permitAll()
